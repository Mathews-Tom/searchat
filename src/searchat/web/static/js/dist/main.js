var na=Object.defineProperty;var M=(e,t)=>()=>(e&&(t=e(e=0)),t);var Fr=(e,t)=>{for(var n in t)na(e,n,{get:t[n],enumerable:!0})};function ar(e){return e==="auto"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function kc(e){return e==="future"||e==="system"?"dark":e==="bare"?"light":["light","dark","auto"].includes(e)?e:"auto"}function lr(e){document.documentElement.setAttribute("data-theme",e);let t=Cc[e];if(t)for(let[n,r]of Object.entries(t))document.documentElement.style.setProperty(n,r)}function Co(e){document.querySelectorAll(".theme-switcher-btn").forEach(n=>{n.classList.toggle("active",n.dataset.themeMode===e)})}function cr(e){localStorage.setItem("theme-preference",e),lr(ar(e)),Co(e)}function ko(){let e=kc(localStorage.getItem("theme-preference")||"auto");localStorage.setItem("theme-preference",e),lr(ar(e)),Co(e);let t=document.getElementById("themeSwitcher");t&&t.addEventListener("click",n=>{let r=n.target.closest(".theme-switcher-btn");if(!r)return;let s=r.dataset.themeMode;s&&cr(s)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{(localStorage.getItem("theme-preference")||"auto")==="auto"&&lr(ar("auto"))})}var Cc,Io=M(()=>{Cc={light:{"--bg-base":"240 20% 97%","--bg-elevated":"0 0% 100%","--bg-glass":"0 0% 100% / 0.55","--bg-glass-hover":"0 0% 100% / 0.72","--bg-glass-active":"0 0% 100% / 0.85","--bg-surface":"220 14% 96%","--bg-surface-hover":"220 14% 93%","--bg-overlay":"220 20% 96% / 0.8","--border-glass":"0 0% 100% / 0.6","--border-subtle":"220 13% 91%","--border-focus":"221 83% 53%","--text-primary":"220 14% 10%","--text-secondary":"220 9% 43%","--text-tertiary":"220 9% 60%","--text-inverse":"0 0% 100%","--accent":"221 83% 53%","--accent-hover":"221 83% 47%","--accent-subtle":"221 83% 53% / 0.08","--accent-glow":"221 83% 53% / 0.15","--success":"142 71% 45%","--warning":"38 92% 50%","--danger":"0 72% 51%","--danger-subtle":"0 72% 51% / 0.08","--shadow-sm":"0 1px 2px hsl(220 14% 10% / 0.04), 0 1px 3px hsl(220 14% 10% / 0.03)","--shadow-md":"0 4px 6px hsl(220 14% 10% / 0.04), 0 2px 4px hsl(220 14% 10% / 0.03)","--shadow-lg":"0 10px 25px hsl(220 14% 10% / 0.06), 0 4px 10px hsl(220 14% 10% / 0.04)","--shadow-glass":"0 8px 32px hsl(220 14% 10% / 0.06), inset 0 1px 0 hsl(0 0% 100% / 0.6)","--blur-glass":"20px","--blur-bg":"40px","--gradient-mesh":"radial-gradient(ellipse at 20% 50%, hsl(221 83% 53% / 0.04) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, hsl(262 83% 58% / 0.04) 0%, transparent 50%), radial-gradient(ellipse at 50% 80%, hsl(190 80% 50% / 0.03) 0%, transparent 50%)","--noise-opacity":"0.015","--tag-bg":"221 83% 53% / 0.08","--tag-text":"221 83% 40%","--scrollbar-track":"220 14% 96%","--scrollbar-thumb":"220 9% 82%","--code-bg":"220 14% 96%"},dark:{"--bg-base":"224 25% 8%","--bg-elevated":"224 22% 12%","--bg-glass":"224 22% 14% / 0.6","--bg-glass-hover":"224 22% 16% / 0.72","--bg-glass-active":"224 22% 18% / 0.85","--bg-surface":"224 20% 14%","--bg-surface-hover":"224 20% 18%","--bg-overlay":"224 25% 8% / 0.85","--border-glass":"224 15% 22% / 0.6","--border-subtle":"224 15% 20%","--border-focus":"217 91% 60%","--text-primary":"220 14% 95%","--text-secondary":"220 9% 65%","--text-tertiary":"220 9% 46%","--text-inverse":"220 14% 10%","--accent":"217 91% 60%","--accent-hover":"217 91% 67%","--accent-subtle":"217 91% 60% / 0.1","--accent-glow":"217 91% 60% / 0.12","--success":"142 71% 45%","--warning":"38 92% 50%","--danger":"0 72% 55%","--danger-subtle":"0 72% 55% / 0.1","--shadow-sm":"0 1px 2px hsl(0 0% 0% / 0.2), 0 1px 3px hsl(0 0% 0% / 0.15)","--shadow-md":"0 4px 6px hsl(0 0% 0% / 0.2), 0 2px 4px hsl(0 0% 0% / 0.15)","--shadow-lg":"0 10px 25px hsl(0 0% 0% / 0.3), 0 4px 10px hsl(0 0% 0% / 0.2)","--shadow-glass":"0 8px 32px hsl(0 0% 0% / 0.25), inset 0 1px 0 hsl(0 0% 100% / 0.04)","--blur-glass":"20px","--blur-bg":"40px","--gradient-mesh":"radial-gradient(ellipse at 20% 50%, hsl(217 91% 60% / 0.06) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, hsl(262 83% 58% / 0.05) 0%, transparent 50%), radial-gradient(ellipse at 50% 80%, hsl(190 80% 50% / 0.04) 0%, transparent 50%)","--noise-opacity":"0.03","--tag-bg":"217 91% 60% / 0.12","--tag-text":"217 91% 72%","--scrollbar-track":"224 20% 12%","--scrollbar-thumb":"224 15% 26%","--code-bg":"224 20% 10%"}}});function ur(){try{let e=localStorage.getItem(dr);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to load search history:",e),[]}}function Ic(e){try{localStorage.setItem(dr,JSON.stringify(e))}catch(t){console.error("Failed to save search history:",t)}}function To(e){let t=ur(),n={query:e.query,mode:e.mode,project:e.project,tool:e.tool,date:e.date,dateFrom:e.dateFrom,dateTo:e.dateTo,sortBy:e.sortBy,timestamp:new Date().toISOString()};if(t.length>0){let r=t[0];if(r.query===n.query&&r.mode===n.mode&&r.project===n.project&&r.tool===n.tool&&r.date===n.date)return}t.unshift(n),t.length>20&&(t.length=20),Ic(t),Ut()}function $o(){localStorage.removeItem(dr),Ut()}function Ao(){if(!document.getElementById("search"))return;let t=document.createElement("div");t.id="searchHistoryContainer",t.style.cssText=`
    ...
    `;t.forEach((r,s)=>{let o=new Date(r.timestamp),i=$c(o),a=[];r.mode&&r.mode!=="hybrid"&&a.push(`mode: ${r.mode}`),r.project&&a.push(`project: ${r.project}`),r.tool&&a.push(`tool: ${r.tool}`),r.date&&r.date!=="all"&&a.push(`date: ${r.date}`);let l=a.length>0?a.join(", "):"no filters";n+=`
    ...
    `}async function Do(){await Hc()}async function Hc(){try{let e=await fetch("/api/bookmarks");if(!e.ok)return;let t=await e.json();De.clear(),t.bookmarks.forEach(n=>{De.add(n.conversation_id)})}catch(e){console.error("Failed to load bookmarks:",e)}}async function Mc(e,t){let n=De.has(e);try{if(n){if(!(await fetch(`/api/bookmarks/${e}`,{method:"DELETE"})).ok)throw new Error("Failed to remove bookmark");De.delete(e),mr(t,!1)}else{if(!(await fetch("/api/bookmarks",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({conversation_id:e,notes:""})})).ok)throw new Error("Failed to add bookmark");De.add(e),mr(t,!0)}}catch(r){console.error("Failed to toggle bookmark:",r),alert("Failed to toggle bookmark. Please try again.")}}function Rc(e){return De.has(e)}function gr(e){let t=document.createElement("button");t.className="bookmark-star",t.dataset.conversationId=e,t.type="button";let n=Rc(e);return mr(t,n),t.addEventListener("click",r=>{r.stopPropagation(),Mc(e,t)}),t}function mr(e,t){t?(e.innerHTML=Ro(!0),e.classList.add("active"),e.title="Remove from bookmarks",e.setAttribute("aria-label","Remove from bookmarks")):(e.innerHTML=Ro(!1),e.classList.remove("active"),e.title="Add to bookmarks",e.setAttribute("aria-label","Add to bookmarks"))}async function vr(){let e=document.getElementById("results"),t=document.getElementById("conversationHeader"),n=document.getElementById("heroTitle"),r=document.getElementById("heroSubtitle"),s=document.getElementById("filters"),o=document.getElementById("chatPanel");t&&(t.style.display="none"),n&&(n.style.display="none"),r&&(r.style.display="none"),s&&(s.style.display="none"),o&&(o.style.display="none"),e.innerHTML='<div class="loading">Loading bookmarks...</div>';try{let i=await fetch("/api/bookmarks");if(!i.ok)throw new Error("Failed to load bookmarks");let a=await i.json();e.innerHTML="";let l=document.createElement("div");if(l.style.cssText=`
            margin-bottom: 20px;
            padding-bottom: 16px;
            border-bottom: 1px solid hsl(var(--border-glass));
        `,l.innerHTML=`
        ...
        `,e.appendChild(l),a.total===0){let c=document.createElement("div");c.className="empty-state",c.innerHTML=`
            ...
            `,u.addEventListener("click",h=>{h.target.classList.contains("remove-bookmark-btn")||(window.location.href=`/conversation/${c.conversation_id}`)}),u.querySelector(".remove-bookmark-btn").addEventListener("click",async h=>{if(h.stopPropagation(),!!confirm(`Remove "${c.title}" from bookmarks?`))try{if(!(await fetch(`/api/bookmarks/${c.conversation_id}`,{method:"DELETE"})).ok)throw new Error("Failed to remove bookmark");De.delete(c.conversation_id),u.remove();let g=l.querySelector("p"),m=a.total-1;g.textContent=`${m} bookmark${m!==1?"s":""}`,e.querySelectorAll(".result").length===0&&vr()}catch(p){console.error("Failed to remove bookmark:",p),alert("Failed to remove bookmark. Please try again.")}}),e.appendChild(u)})}catch(i){e.innerHTML=`<div style="color: hsl(var(--danger));">Error: ${i.message}</div>`}}var De,yr=M(()=>{De=new Set});function Oe(){let e=localStorage.getItem(br);return e?String(e):""}function ht(){return!!Oe()}function Oo(e){let t=e?String(e):"";if(!t){localStorage.removeItem(br);return}localStorage.setItem(br,t)}function te(e){let t=Oe();return t&&e.set("snapshot",t),e}function Dc(e){let t=document.getElementById("datasetBanner");if(!t)return;if(!e){t.style.display="none",t.innerHTML="";return}t.style.display="block",t.innerHTML=`
    ...
    `;let n=document.getElementById("datasetReturnActive");n&&n.addEventListener("click",function(){Oo(""),window.location.href="/"})}function Oc(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function Pc(e){let t=["indexMissingButton","createBackupButton","manageBackupsButton","analyticsButton","dashboardsButton","chatSend","chatStop","semanticHighlights","saveQueryButtonInline"];for(let r of t){let s=document.getElementById(r);s&&(s.disabled=!0,s.title=`Disabled in snapshot mode (${e})`)}let n=document.getElementById("chatPanel");n&&(n.style.display="none")}async function jc(e){let t=await fetch("/api/backup/list");if(!t.ok)return[];let n=await t.json();return(Array.isArray(n.backups)?n.backups:[]).filter(function(s){return Object.prototype.hasOwnProperty.call(s,"snapshot_browsable")?!!s.snapshot_browsable:!0}).map(function(s){return String(s.backup_path||"").split(/[/\\]/).pop()}).filter(Boolean)}async function Po(){let e=document.getElementById("datasetSelect");if(!e)return;try{let r=await fetch("/api/status/features");if(r.ok){let s=await r.json();if(!!!(s&&s.snapshots&&s.snapshots.enabled)){let i=document.getElementById("datasetPanel");i&&(i.style.display="none");return}}}catch{}let t=Oe();e.innerHTML="";let n=document.createElement("option");n.value="",n.textContent="Active index",e.appendChild(n);try{let r=await jc(e);for(let s of r){let o=document.createElement("option");o.value=s,o.textContent=s,e.appendChild(o)}}catch{}e.value=t,Dc(t),t&&Pc(t),e.addEventListener("change",function(){Oo(e.value),window.location.href="/"})}var br,Xe=M(()=>{br="searchatSnapshotName"});function qc(e){return e==="opencode"?"OpenCode":e==="vibe"?"Vibe":e==="codex"?"Codex":e==="gemini"?"Gemini CLI":e==="continue"?"Continue":e==="cursor"?"Cursor":e==="aider"?"Aider":e==="omp"?"Oh My Pi":"Claude Code"}async function jo(e,t){t.innerHTML='<div class="loading">Finding similar conversations...</div>';try{let n=te(new URLSearchParams({limit:"5"})),r=await fetch(`/api/conversation/${e}/similar?${n.toString()}`);if(!r.ok){let i=await r.json().catch(()=>null),a=i&&i.detail?i.detail:"Failed to load similar conversations";t.innerHTML=`<div style="color: hsl(var(--text-tertiary)); padding: 20px; text-align: center;">${a}</div>`;return}let s=await r.json();if(!s.similar_conversations||s.similar_conversations.length===0){t.innerHTML=`
        ...
        `;s.similar_conversations.forEach((i,a)=>{let l=qc(i.tool),c=Math.round(i.similarity_score*100),u=new Date(i.created_at).toLocaleDateString(),d="hsl(var(--success))";c<70&&(d="hsl(var(--warning))"),c<50&&(d="hsl(var(--text-tertiary))"),o+=`
            ...
            `}),t.innerHTML=o,t.querySelectorAll(".similar-conversation-item").forEach(i=>{i.addEventListener("click",()=>{let a=i.dataset.conversationId;window.location.href=`/conversation/${a}`})})}catch(n){t.innerHTML=`<div style="color: hsl(var(--danger));">Error: ${n.message}</div>`}}var qo=M(()=>{Xe()});var Fo={};Fr(Fo,{addCheckboxToResult:()=>Wt,initBulkExport:()=>Nc,isBulkModeActive:()=>Kc,toggleBulkMode:()=>Fc});function Nc(){}function Fc(){Qe=!Qe,he.clear();let t=document.getElementById("results").querySelectorAll(".result");Qe?(t.forEach(n=>{let r=No(n.dataset.conversationId);n.insertBefore(r,n.firstChild)}),Vc()):(t.forEach(n=>{let r=n.querySelector(".bulk-checkbox");r&&r.remove()}),zc()),Jc()}function No(e){let t=document.createElement("div");t.className="bulk-checkbox",t.style.cssText=`
        float: left;
        margin-right: 12px;
        margin-top: 2px;
    ...
    `,n.addEventListener("change",r=>{r.stopPropagation(),n.checked?he.add(e):he.delete(e),Er()}),t.appendChild(n),t}function Vc(){let e=document.getElementById("bulkToolbar");e||(e=document.createElement("div"),e.id="bulkToolbar",e.className="glass-elevated",e.style.cssText=`
            position: fixed;
            bottom: 20px;
            left: 50%;
        ...
        `,document.body.appendChild(e),document.getElementById("bulkSelectAll").addEventListener("click",Uc),document.getElementById("bulkDeselectAll").addEventListener("click",Wc),document.getElementById("bulkExportJson").addEventListener("click",()=>xr("json")),document.getElementById("bulkExportMarkdown").addEventListener("click",()=>xr("markdown")),document.getElementById("bulkExportText").addEventListener("click",()=>xr("text"))),e.style.display="flex"}function zc(){let e=document.getElementById("bulkToolbar");e&&(e.style.display="none")}function Er(){let e=document.getElementById("bulkCount");if(e){let t=he.size;e.textContent=`${t} selected`}}function Uc(){document.getElementById("results").querySelectorAll('.bulk-checkbox input[type="checkbox"]').forEach(n=>{n.checked=!0,he.add(n.dataset.conversationId)}),Er()}function Wc(){document.getElementById("results").querySelectorAll('.bulk-checkbox input[type="checkbox"]').forEach(n=>{n.checked=!1}),he.clear(),Er()}async function xr(e){if(he.size===0){alert("Please select at least one conversation to export");return}if(he.size>100){alert("Maximum 100 conversations can be exported at once");return}try{let t=te(new URLSearchParams),n=t.toString()?`/api/conversations/bulk-export?${t.toString()}`:"/api/conversations/bulk-export",r=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({conversation_ids:Array.from(he),format:e})});if(!r.ok)throw new Error("Export failed");let s=await r.blob(),o=window.URL.createObjectURL(s),i=document.createElement("a");i.href=o,i.download=`searchat_export_${Date.now()}.zip`,document.body.appendChild(i),i.click(),window.URL.revokeObjectURL(o),i.remove();let a=document.getElementById("bulkCount");if(a){let l=a.textContent;a.textContent="\u2713 Export complete!",a.style.color="hsl(var(--success))",setTimeout(()=>{a.textContent=l,a.style.color="hsl(var(--text-primary))"},3e3)}}catch(t){console.error("Bulk export failed:",t),alert("Failed to export conversations. Please try again.")}}function Jc(){let e=document.getElementById("bulkModeToggle");e&&(Qe?(e.textContent="\u2715 Exit Bulk Mode",e.style.borderColor="hsl(var(--danger))",e.style.color="hsl(var(--danger))"):(e.textContent="Bulk Export",e.style.borderColor="hsl(var(--accent))",e.style.color=""))}function Kc(){return Qe}function Wt(e,t){if(Qe){let n=No(t);e.insertBefore(n,e.firstChild)}}var he,Qe,wr=M(()=>{Xe();he=new Set,Qe=!1});function _r(e){mt=e}function Jt(){return(Q-1)*Sr}function Cr(e,t){if(mt===0)return;let n=Math.ceil(mt/Sr);if(n<=1)return;let r=`
    ...
    `;e.insertAdjacentHTML("beforeend",r)}function Xc(e){let n=[];if(e<=7)for(let r=1;r<=e;r++)n.push(r);else if(Q<=4){for(let r=1;r<=5;r++)n.push(r);n.push("..."),n.push(e)}else if(Q>=e-3){n.push(1),n.push("...");for(let r=e-4;r<=e;r++)n.push(r)}else{n.push(1),n.push("...");for(let r=Q-1;r<=Q+1;r++)n.push(r);n.push("..."),n.push(e)}return n.map(r=>r==="..."?'<span style="color: hsl(var(--text-tertiary)); padding: 8px;">...</span>':`
        ...
        `).join("")}async function Kt(e,t){let n=Math.ceil(mt/Sr);e<1||e>n||(Q=e,window.scrollTo({top:0,behavior:"smooth"}),t&&await t())}function Vo(){Q=1}var Q,mt,Sr,kr=M(()=>{Q=1,mt=0,Sr=20});function Qc(e){return new Promise(function(t){setTimeout(t,e)})}function Wo(){return Xt}function Uo(e){let t=document.getElementById("projectSummary");if(!t)return;if(!e){t.style.display="none",t.innerHTML="";return}let n=null;for(let r of Xt)if(r.project_id===e){n=r;break}if(!n){t.style.display="none",t.innerHTML="";return}t.style.display="block",t.innerHTML=`
    ...
    `}async function Qt(){let e=te(new URLSearchParams),t=e.toString()?`/api/projects/summary?${e.toString()}`:"/api/projects/summary",n=await fetch(t);if(n.status===503){let i=await n.json();if(i&&i.status==="warming")return await Qc(i.retry_after_ms||500),Qt();console.error("Failed to load projects:",i);return}if(!n.ok){let i=await n.json().catch(function(){return null});console.error("Failed to load projects:",i);return}let r=await n.json(),s=document.getElementById("project"),o=s.value;Xt=Array.isArray(r)?r:[];for(let i of Xt){let a=document.createElement("option");a.value=i.project_id;let l=`${i.project_id} (${i.conversation_count})`;i.project_id.startsWith("opencode-")?a.textContent=`OpenCode \u2022 ${l}`:i.project_id.startsWith("vibe-")?a.textContent=`Vibe \u2022 ${l}`:a.textContent=`Claude Code \u2022 ${l}`,s.appendChild(a)}if(o&&(s.value=o),!zo){let i=function(){Uo(s.value)};s.addEventListener("change",i),zo=!0}Uo(s.value)}async function Jo(){let e=document.getElementById("results");e.innerHTML='<div class="loading">Scanning for missing conversations... This may take a minute...</div>';try{let n=await(await fetch("/api/index_missing",{method:"POST"})).json();if(n.success){let r=n.failed_conversations||0,s=n.empty_conversations||0,o=[];s>0&&o.push(`<strong>${s} empty sessions</strong> skipped`),r>0&&o.push(`<strong style="color: hsl(var(--danger));">${r} failed</strong>`);let i=o.length>0?" | "+o.join(" | "):"";if(n.new_conversations===0){let a=r>0?"notification-warning":"notification-info",l=r>0?`All valid conversations indexed (${r} corrupt files skipped)`:"All conversations are already indexed";e.innerHTML=`
        ...
        `}}var Xt,zo,Ir=M(()=>{Xe();Xt=[],zo=!1});function Zt(e){return Gc.every(t=>e?.components?.[t]==="ready")}function nd(e){if(!e)return!1;try{return localStorage.getItem(Qo)===String(e)}catch(t){return console.warn("Splash: failed to read localStorage",t),!1}}function Yo(e){if(e)try{localStorage.setItem(Qo,String(e))}catch(t){console.warn("Splash: failed to write localStorage",t)}}function rd(){try{localStorage.removeItem(Yc)}catch(e){console.warn("Splash: failed to clear legacy localStorage key",e)}}function Go(){let e=document.getElementById("sidebarWarmupIndicator");return e?getComputedStyle(e).display!=="none"?(gt===null&&(gt=Date.now()),Date.now()-gt>ed?(console.warn("isWarmingUp: warmup exceeded maximum duration, unblocking search/chat"),e.style.display="none",gt=null,!1):!0):(gt=null,!1):!1}function Gt(e){if(e===Xo)return;Xo=e;let t=document.getElementById("search"),n=document.querySelector(".search-wrap"),r=document.getElementById("chatNavLink");if(t&&(t.disabled=e),n&&n.classList.toggle("warming-up",e),r)if(e)r.dataset.href=r.getAttribute("href"),r.removeAttribute("href"),r.setAttribute("aria-disabled","true"),r.style.pointerEvents="none",r.style.opacity="0.5";else{let s=r.dataset.href;s&&(r.setAttribute("href",s),delete r.dataset.href),r.removeAttribute("aria-disabled"),r.style.pointerEvents="",r.style.opacity=""}}async function Zo(){try{rd();let t=await(await fetch("/api/status")).json();if(Yt=t.server_started_at||t.warmup_started_at||null,Zt(t)){Yo(Yt),Gt(!1);return}if(nd(Yt))return;Gt(!0),sd(t),ad()}catch(e){console.error("Failed to check warmup status:",e)}}function sd(e){let t=document.createElement("div");t.id="splashOverlay",t.className="splash-overlay";let n=document.createElement("div");n.className="splash-content";let r=document.createElement("div");r.className="splash-header",r.innerHTML=`
    ...
    `,r.classList.add(`splash-progress-${t}`),r}function id(e){return{services:"Services",duckdb:"Database",parquet:"Data Files",search_engine:"Search Engine",faiss:"FAISS Index",metadata:"Metadata",embedder:"AI Embeddings",embedded_model:"Embedded LLM",indexer:"Indexer"}[e]||e}function ad(){me&&clearInterval(me),me=setInterval(async()=>{try{let t=await(await fetch("/api/status")).json();ei(t),Zt(t)&&me&&(clearInterval(me),me=null)}catch(e){console.error("Failed to poll status:",e)}},500)}async function ld(){Yo(Yt);let e=!1;try{let n=await fetch("/api/status");if(!n.ok)throw new Error(`Status API returned ${n.status}`);let r=await n.json();e=Zt(r)}catch(n){console.warn("dismissSplash: status check failed, assuming not ready",n)}me&&(clearInterval(me),me=null);let t=document.getElementById("splashOverlay");t&&(t.classList.remove("splash-visible"),setTimeout(()=>t.remove(),300)),e?Gt(!1):cd()}function cd(){if(Ye)return;let e=document.getElementById("sidebarWarmupIndicator");if(!e){console.warn("showSidebarWarmupIndicator: #sidebarWarmupIndicator not found in DOM");return}e.style.display="";let t=0;Ye=setInterval(async()=>{try{let n=await fetch("/api/status");if(!n.ok)throw new Error(`HTTP ${n.status}`);let r=await n.json(),s=Zt(r);t=0,s&&(clearInterval(Ye),Ye=null,e.style.display="none",Gt(!1))}catch(n){if(t++,console.warn("Sidebar warmup poll failed:",n),t>=td){clearInterval(Ye),Ye=null;let r=e.querySelector(".sidebar-warmup-label");r&&(r.textContent="Warmup check failed \u2014 reload page")}}},500)}var Qo,Yc,Gc,Zc,me,Yt,Ye,gt,Xo,ed,td,Tr=M(()=>{Qo="searchatSplashDismissedServerStartedAt",Yc="searchatSplashShown",Gc=["embedder","faiss","metadata"],Zc=[{icon:"\u{1F50D}",title:"3 Search Modes",desc:"Hybrid (DuckDB FTS + FAISS), Semantic, Keyword"},{icon:"\u26A1",title:"<100ms Search",desc:"Ultra-fast hybrid search with RRF fusion"},{icon:"\u{1F3AF}",title:"Smart Matching",desc:"Autocomplete, synonym expansion, cross-encoder re-ranking"},{icon:"\u{1F916}",title:"8 AI Agents",desc:"Claude, Vibe, OpenCode, Codex, Gemini, Continue, Cursor, Aider"},{icon:"\u{1F50C}",title:"MCP Server",desc:"8 tools for MCP clients (search, patterns, agent config)"},{icon:"\u{1F4AC}",title:"Session Chat",desc:"Multi-turn RAG with 30-min session persistence"},{icon:"\u{1F9E9}",title:"Pattern Mining",desc:"Extract recurring coding patterns via LLM"},{icon:"\u{1F4CB}",title:"Agent Config",desc:"Generate CLAUDE.md, copilot-instructions, cursorrules"},{icon:"\u{1F517}",title:"Similarity Search",desc:"Discover related conversations"},{icon:"\u{1F516}",title:"Bookmarks",desc:"Save and annotate favorites"},{icon:"\u{1F4CA}",title:"Analytics",desc:"Track search patterns and trends"},{icon:"\u{1F6E1}\uFE0F",title:"Append-Only",desc:"Never deletes existing data"},{icon:"\u{1F4C8}",title:"55+ API Endpoints",desc:"Comprehensive REST API with 14 routers"}],me=null,Yt=null,Ye=null,gt=null,Xo=!1,ed=12e4,td=20});var sn={};Fr(sn,{initProjectSuggestion:()=>Br,loadConversationView:()=>we,resumeSession:()=>Ge,search:()=>Ee,showAllConversations:()=>vt,showSearchView:()=>Y,toggleCustomDate:()=>rn});function si(){return`
        <svg class="copy-action-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <rect x="9" y="9" width="10" height="10" rx="2" stroke="currentColor" stroke-width="2"></rect>
            <path d="M15 9V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2" stroke="currentColor" stroke-width="2"></path>
        </svg>
...
`).length,o=s>30;return{html:`
        ...
        `,collapsed:o}}function oi(e,t,n){if(!e)return"";let r=/```(\w+)?\n([\s\S]*?)```/g,s=0,o,i="";for(;(o=r.exec(e))!==null;){let l=e.slice(s,o.index);l&&(i+=`<div class="snippet-text">${en(l,t,n)}</div>`);let c=o[1]||"plaintext",u=o[2]||"",d=md(u.trim(),c);i+=d.html,s=o.index+o[0].length}let a=e.slice(s);return a&&(i+=`<div class="snippet-text">${en(a,t,n)}</div>`),i||(i=`<div class="snippet-text">${en(e,t,n)}</div>`),i}function gd(e){let t=e.summary||{added:0,removed:0,unchanged:0},n=e.added||[],r=e.removed||[],s=e.unchanged||[];return`
...
`))}</pre>
    ...
    `}function ii(e){if(ti)return;async function t(n){let r=n.target,s=r.closest(".snippet-copy");if(s){n.stopPropagation();let o=s.dataset.codeId,i=nn.get(o)||"";if(!i)return;try{await navigator.clipboard.writeText(i),s.innerHTML=dd(),s.classList.add("is-copied"),s.setAttribute("title","Copied"),s.setAttribute("aria-label","Copied"),setTimeout(function(){s.innerHTML=si(),s.classList.remove("is-copied"),s.setAttribute("title","Copy snippet"),s.setAttribute("aria-label","Copy snippet")},1500)}catch(a){console.error("Failed to copy snippet code:",a),s.classList.add("is-copy-error"),s.setAttribute("title","Copy failed"),s.setAttribute("aria-label","Copy failed"),setTimeout(function(){s.classList.remove("is-copy-error"),s.setAttribute("title","Copy snippet"),s.setAttribute("aria-label","Copy snippet")},1500)}return}if(r.classList.contains("snippet-toggle")){n.stopPropagation();let o=r.closest(".snippet-code-block");if(!o)return;let i=o.querySelector(".snippet-code");if(!i)return;let a=i.classList.contains("collapsed");i.classList.toggle("collapsed"),r.textContent=a?"Collapse":"Expand";return}if(r.classList.contains("diff-btn")){n.stopPropagation();let o=r.closest(".result");if(!o)return;let i=o.querySelector(".result-diff");if(!i||!i.classList.toggle("open")||i.dataset.loaded==="true")return;let l=o.dataset.conversationId,c=o.dataset.messageStart,u=o.dataset.messageEnd,d=new URLSearchParams;c&&d.append("source_start",c),u&&d.append("source_end",u),te(d),i.innerHTML='<div class="loading">Loading diff...</div>';try{let f=await fetch(`/api/conversation/${l}/diff?${d.toString()}`);if(!f.ok){let p=await f.json().catch(()=>null),g=p&&p.detail?p.detail:"Failed to load diff";i.innerHTML=`<div class="diff-error">${g}</div>`;return}let h=await f.json();i.innerHTML=gd(h),i.dataset.loaded="true"}catch(f){i.innerHTML=`<div class="diff-error">Error: ${f.message}</div>`}}}e.addEventListener("click",t),ti=!0}function vd(e){return new Promise(function(t){setTimeout(t,e)})}async function yd(e,t){let n=String(e||"");if(n)try{if(await navigator.clipboard.writeText(n),!t)return;let r=t.textContent;t.textContent="Copied",t.classList.add("copied"),setTimeout(function(){t.textContent=r,t.classList.remove("copied")},1500)}catch(r){console.error("Failed to copy text:",r)}}async function Ee(e=!0,t=0){if(Go()){console.debug("search(): blocked by warmup guard"),document.getElementById("results").innerHTML='<div class="loading">Search engine is still warming up\u2026</div>';return}$r+=1;let n=$r,r=document.getElementById("search").value,s=document.getElementById("project").value,o=document.getElementById("tool").value,i=document.getElementById("date").value;if(!r&&!s&&!o&&!i){document.getElementById("results").innerHTML="<div>Enter a search query or select a filter</div>";return}e&&Vo();let a=document.getElementById("results");a.innerHTML='<div class="loading">Searching...</div>',nn.clear(),Lr=0;let l=new URLSearchParams({q:r||"*",mode:document.getElementById("mode").value,project:document.getElementById("project").value,tool:o,date:document.getElementById("date").value,sort_by:document.getElementById("sortBy").value,offset:Jt()}),c=document.getElementById("chatProvider")?.value,u=document.getElementById("chatModel")?.value;if(document.getElementById("semanticHighlights")?.checked&&r.trim().length>=4&&document.getElementById("mode").value!=="keyword"&&c&&(l.append("highlight","true"),l.append("highlight_provider",c),u&&l.append("highlight_model",u)),document.getElementById("date").value==="custom"){let y=document.getElementById("dateFrom").value,x=document.getElementById("dateTo").value;y&&l.append("date_from",y),x&&l.append("date_to",x)}let h=document.getElementById("project").value;o||(h.startsWith("opencode-")?l.append("tool","opencode"):h.startsWith("vibe-")?l.append("tool","vibe"):h==="codex"?l.append("tool","codex"):h==="gemini"||h.startsWith("gemini-")?l.append("tool","gemini"):h==="continue"||h.startsWith("continue-")?l.append("tool","continue"):h==="cursor"||h.startsWith("cursor-")?l.append("tool","cursor"):(h==="aider"||h.startsWith("aider-"))&&l.append("tool","aider")),te(l);let p=await fetch(`/api/search?${l}`);if(p.status===503){let y=await p.json();if(y&&y.status==="warming"){let b=y.retry_after_ms||500,j=Math.min(b*Math.pow(2,t),5e3);if(t>=6){let V=y.errors?JSON.stringify(y.errors):"No warmup details available.";a.innerHTML=`
                ...
                `;let B=document.getElementById("fallbackKeyword");B&&B.addEventListener("click",function(){return document.getElementById("mode").value="keyword",Ee()});return}return a.innerHTML='<div class="loading">Warming up search engine\u2026</div>',await vd(j),n===$r?Ee(!1,t+1):void 0}let x=ri(y,"Search warming failed");a.innerHTML=`<div style="color: hsl(var(--danger));">${x}</div>`;return}if(!p.ok){let y=await p.json().catch(()=>null),x=ri(y,"Search failed");a.innerHTML=`<div style="color: hsl(var(--danger));">${x}</div>`;return}let g=await p.json();if(_r(g.total),a.innerHTML="",g.results.length===0){a.innerHTML="<div>No results found</div>",tn();return}let m=Array.isArray(g.highlight_terms)?g.highlight_terms:[],v=g.total>20?` (page ${Math.floor(Jt()/20)+1})`:"";a.innerHTML=`<div class="results-header">Found ${g.total} results in ${Math.round(g.search_time_ms)}ms${v}</div>`,g.results.forEach((y,x)=>{let b=document.createElement("div"),j=y.source==="WSL";b.className=`result ${j?"wsl":"windows"}`,b.style.animationDelay=`${x*.04}s`,b.id=`result-${x}`,b.dataset.conversationId=y.conversation_id,typeof y.message_start_index=="number"&&(b.dataset.messageStart=String(y.message_start_index)),typeof y.message_end_index=="number"&&(b.dataset.messageEnd=String(y.message_end_index));let V=y.conversation_id.split("-").pop(),B=y.tool||"claude",z=Hr(B),E=en(y.title,r,m),S=oi(y.snippet,r,m),_=Oe(),C=_?`<button class="resume-btn" data-conversation-id="${y.conversation_id}" disabled title="Disabled in snapshot mode (${oe(_)})">\u26A1 Resume (disabled)</button>`:`<button class="resume-btn" data-conversation-id="${y.conversation_id}">\u26A1 Resume Session</button>`;b.innerHTML=`
            <div class="result-title">${E}</div>
            <div class="result-meta">
                <span class="tool-badge ${B}">${z}</span> \u2022
        ...
        `,Wt(b,y.conversation_id);let w=b.querySelector(".result-title"),k=gr(y.conversation_id);w.appendChild(k);let L=b.querySelector(".resume-btn");L&&!ht()&&L.addEventListener("click",U=>{U.stopPropagation(),Ge(y.conversation_id,L)}),b.onclick=()=>{tn(),sessionStorage.setItem("lastScrollPosition",window.scrollY),sessionStorage.setItem("lastResultIndex",x),sessionStorage.setItem("activeConversationId",y.conversation_id),we(y.conversation_id)},a.appendChild(b)}),Cr(a,Ee),ii(a),To({query:r,mode:document.getElementById("mode").value,project:document.getElementById("project").value,tool:o,date:document.getElementById("date").value,dateFrom:document.getElementById("date").value==="custom"?document.getElementById("dateFrom").value:"",dateTo:document.getElementById("date").value==="custom"?document.getElementById("dateTo").value:"",sortBy:document.getElementById("sortBy").value}),tn()}function Y(){let e=document.getElementById("conversationHeader"),t=document.getElementById("heroTitle"),n=document.getElementById("heroSubtitle"),r=document.getElementById("filters"),s=document.getElementById("chatPanel"),o=document.getElementById("results");if(e&&(e.style.display="none"),r&&(r.style.display=""),s&&(s.style.display="block"),sessionStorage.removeItem("activeConversationId"),o){o.innerHTML="";let i=sessionStorage.getItem("lastView"),a=!!sessionStorage.getItem("searchState"),l=!!sessionStorage.getItem("allConversationsState");i||a||l?o.innerHTML='<div class="loading">Restoring results...</div>':o.innerHTML="<div>Enter a search query or select a filter</div>"}}function rn(){let e=document.getElementById("date"),t=document.getElementById("customDateRange");t.style.display=e.value==="custom"?"inline":"none"}async function Ge(e,t){if(ht()){console.error("Resume is disabled in snapshot mode");return}let n=t.innerHTML;t.innerHTML="\u23F3 Opening...",t.disabled=!0;try{let r=await fetch("/api/resume",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({conversation_id:e})}),s=await r.json();if(r.ok&&s.success)t.innerHTML="\u2713 Opened in terminal",t.classList.add("success"),setTimeout(()=>{t.innerHTML=n,t.classList.remove("success"),t.disabled=!1},2e3);else throw new Error(s.detail||"Failed to resume session")}catch(r){t.innerHTML="\u274C Failed - check console",t.classList.add("error"),console.error("Resume error:",r),setTimeout(()=>{t.innerHTML=n,t.classList.remove("error"),t.disabled=!1},3e3)}}async function vt(){let e=document.getElementById("results");e.innerHTML='<div class="loading">Loading all conversations...</div>',nn.clear(),Lr=0;let t=document.getElementById("sortBy").value,n=document.getElementById("project").value,r=document.getElementById("tool").value,s=document.getElementById("date").value,o="length";t==="date_newest"?o="date_newest":t==="date_oldest"?o="date_oldest":t==="messages"&&(o="length");let i=new URLSearchParams({sort_by:o});if(n&&i.append("project",n),r?i.append("tool",r):n&&(n.startsWith("opencode-")?i.append("tool","opencode"):n.startsWith("vibe-")&&i.append("tool","vibe")),i.has("project")){let c=i.get("project")||"";c.startsWith("opencode-")?i.append("tool","opencode"):c.startsWith("vibe-")&&i.append("tool","vibe")}if(s&&(i.append("date",s),s==="custom")){let c=document.getElementById("dateFrom").value,u=document.getElementById("dateTo").value;c&&i.append("date_from",c),u&&i.append("date_to",u)}te(i);let a=50,l=Jt();i.set("limit",a),i.set("offset",l);try{let u=await(await fetch(`/api/conversations/all?${i}`)).json();if(e.innerHTML="",u.results.length===0){e.innerHTML="<div>No conversations found</div>";return}let d=n?` in project "${n}"`:"",h=s?` ${{today:"from today",week:"from last 7 days",month:"from last 30 days",custom:"from custom date range"}[s]||""}`:"",p=l+1,g=l+u.results.length;e.innerHTML=`<div class="results-header">Showing ${p}\u2013${g} of ${u.total} conversations${d}${h} (sorted by ${o})</div>`;let m=document.createDocumentFragment();u.results.forEach((v,y)=>{let x=l+y,b=document.createElement("div"),j=v.source==="WSL";b.className=`result ${j?"wsl":"windows"}`,b.style.animationDelay=`${y*.04}s`,b.id=`result-${x}`,b.dataset.conversationId=v.conversation_id;let V=v.conversation_id.split("-").pop(),B=v.tool||"claude",z=Hr(B),E=oi(v.snippet,"",[]),S=Oe(),_=S?`<button class="resume-btn" data-conversation-id="${v.conversation_id}" disabled title="Disabled in snapshot mode (${oe(S)})">\u26A1 Resume (disabled)</button>`:`<button class="resume-btn" data-conversation-id="${v.conversation_id}">\u26A1 Resume Session</button>`;b.innerHTML=`
                ...
                <div class="result-diff" data-loaded="false"></div>
            `,Wt(b,v.conversation_id);let C=b.querySelector(".result-title"),w=gr(v.conversation_id);C.appendChild(w);let k=b.querySelector(".resume-btn");k&&!ht()&&k.addEventListener("click",L=>{L.stopPropagation(),Ge(v.conversation_id,k)}),b.onclick=()=>{Ar(),sessionStorage.setItem("lastScrollPosition",window.scrollY),sessionStorage.setItem("lastResultIndex",x),sessionStorage.setItem("activeConversationId",v.conversation_id),we(v.conversation_id)},m.appendChild(b)}),e.appendChild(m),_r(u.total),window.goToPage=v=>Kt(v,vt),Cr(e,vt),Ar(),ii(e)}catch(c){e.innerHTML=`<div style="color: hsl(var(--danger));">Error: ${c.message}</div>`}}async function we(e,t=!0){if(!e){let d=sessionStorage.getItem("activeConversationId");if(d)e=d;else return}let n=document.getElementById("results"),r=document.getElementById("conversationHeader"),s=document.getElementById("heroTitle"),o=document.getElementById("heroSubtitle"),i=document.getElementById("filters"),a=document.getElementById("chatPanel");r&&(r.style.display="block"),s&&(s.style.display="none"),o&&(o.style.display="none"),i&&(i.style.display="none"),a&&(a.style.display="none");let l=document.querySelector("#conversationHeader .back-button");l&&(l.onclick=async d=>{d.preventDefault(),history.pushState({},"","/"),Y(),await ie()}),n.innerHTML="";let c=document.createElement("div");c.className="results-header",c.textContent=`Loading conversation ${e}...`,n.appendChild(c);let u=document.createElement("div");u.className="loading",u.textContent="Loading conversation...",n.appendChild(u);try{t&&history.pushState({conversationId:e},"",`/conversation/${e}`);let d=te(new URLSearchParams),f=d.toString()?`/api/conversation/${e}?${d.toString()}`:`/api/conversation/${e}`,h=await fetch(f);if(!h.ok){let I=await h.json().catch(()=>null),$=I&&I.detail?I.detail:"Failed to load conversation";n.innerHTML="";let J=document.createElement("div");J.style.color="hsl(var(--danger))",J.textContent=$,n.appendChild(J);return}let p=await h.json();c.textContent=`Loaded ${e} | messages: ${Array.isArray(p.messages)?p.messages.length:0}`;let g=p.tool||pd(p.file_path),m=Hr(g),v=p.project_path||"",y=v?`Project: ${v}`:`Project: ${p.project_id||"Unknown"}`;n.innerHTML="";let x=document.createElement("div");x.className="header";let b=document.createElement("span");b.className=`tool-badge ${g}`,b.textContent=m;let j=document.createElement("h2");j.textContent=p.title||"No title available";let V=document.createElement("div");V.textContent=`${y} | Messages: ${p.message_count||0}`;let B=document.createElement("div");B.className="result-actions";let z=document.createElement("button");z.className="resume-btn",z.dataset.conversationId=p.conversation_id,ht()?(z.textContent="\u26A1 Resume (disabled)",z.disabled=!0,z.title=`Disabled in snapshot mode (${Oe()})`):(z.textContent="\u26A1 Resume Session",z.addEventListener("click",I=>{I.stopPropagation(),Ge(p.conversation_id,z)}));let E=document.createElement("div");E.style.cssText="position: relative; display: inline-block;";let S=document.createElement("button");S.className="export-btn",S.textContent="\u{1F4E5} Export",S.style.cssText=`
            background: hsl(var(--accent));
            color: white;
            border: none;
            padding: 8px 16px;
        ...
        `;let _=document.createElement("div");_.style.cssText=`
            ...
            z-index: 1000;
            min-width: 150px;
        `,[{value:"json",label:"\u{1F4C4} JSON",desc:"Structured data"},{value:"markdown",label:"\u{1F4DD} Markdown",desc:"Formatted text"},{value:"text",label:"\u{1F4C3} Plain Text",desc:"Simple text"}].forEach(I=>{let $=document.createElement("div");$.style.cssText=`
                padding: 10px 14px;
                cursor: pointer;
            ...
            `,$.addEventListener("mouseenter",()=>{$.style.background="hsl(var(--bg-surface))"}),$.addEventListener("mouseleave",()=>{$.style.background="transparent"}),$.addEventListener("click",()=>{bd(p.conversation_id,I.value),_.style.display="none"}),_.appendChild($)}),_.lastChild.style.borderBottom="none",S.addEventListener("click",I=>{I.stopPropagation(),_.style.display=_.style.display==="none"?"block":"none"}),document.addEventListener("click",I=>{E.contains(I.target)||(_.style.display="none")}),E.appendChild(S),E.appendChild(_),B.appendChild(z),B.appendChild(E),x.appendChild(b),x.appendChild(j),x.appendChild(V),x.appendChild(B),n.appendChild(x);let w=document.createElement("div");w.className="conversation-tabs";let k=document.createElement("button");k.className="tab-button active",k.textContent="Messages";let L=document.createElement("button");L.className="tab-button",L.textContent="Code";let U=document.createElement("button");U.className="tab-button",U.textContent="Similar";let D=document.createElement("div");D.id="messagesContainer",D.style.display="block";let ne=document.createElement("div");ne.id="codeContainer",ne.style.display="none";let ae=document.createElement("div");ae.id="similarContainer",ae.style.display="none";let _e=(I,$)=>{[k,L,U].forEach(J=>{J.classList.remove("active")}),[D,ne,ae].forEach(J=>{J.style.display="none"}),I.classList.add("active"),$.style.display="block"};if(k.addEventListener("click",()=>{_e(k,D)}),L.addEventListener("click",()=>{_e(L,ne),ne.dataset.loaded||(Mo(e,ne),ne.dataset.loaded="true")}),U.addEventListener("click",()=>{_e(U,ae),ae.dataset.loaded||(jo(e,ae),ae.dataset.loaded="true")}),w.appendChild(k),w.appendChild(L),w.appendChild(U),n.appendChild(w),n.appendChild(D),n.appendChild(ne),n.appendChild(ae),p.messages&&Array.isArray(p.messages)&&p.messages.length>0)p.messages.forEach((I,$)=>{let J=document.createElement("div");J.className=`message ${I.role||"unknown"}`;let ue=document.createElement("div");ue.className="message-header";let rt=document.createElement("div");rt.className="role",rt.textContent=`${(I.role||"unknown").toUpperCase()} - Message ${$+1}`;let T=document.createElement("div");T.className="message-actions";let H=document.createElement("button");H.className="message-copy",H.type="button",H.textContent="Copy",H.addEventListener("click",async ta=>{ta.stopPropagation(),await yd(I.content||"",H)}),T.appendChild(H),ue.appendChild(rt),ue.appendChild(T);let G=document.createElement("div");G.className="content",G.textContent=I.content||"",J.appendChild(ue),J.appendChild(G),D.appendChild(J)});else{let I=document.createElement("div");I.className="message",I.textContent="No messages available",D.appendChild(I)}sessionStorage.setItem("activeConversationId",e)}catch(d){n.innerHTML="";let f=document.createElement("div");f.style.color="hsl(var(--danger))",f.textContent=`Error: ${d.message}`,n.appendChild(f)}}function bd(e,t){let n=document.createElement("a"),r=new URLSearchParams({format:t});te(r),n.href=`/api/conversation/${e}/export?${r.toString()}`,n.download=`conversation-${e}.${t==="markdown"?"md":t}`,document.body.appendChild(n),n.click(),document.body.removeChild(n)}var $r,nn,Lr,ti,Se=M(()=>{Ze();fr();hr();yr();qo();wr();kr();Ir();Xe();Tr();$r=0,nn=new Map,Lr=0,ti=!1});function tn(){let e={query:document.getElementById("search").value,mode:document.getElementById("mode").value,project:document.getElementById("project").value,tool:document.getElementById("tool").value,date:document.getElementById("date").value,dateFrom:document.getElementById("dateFrom").value,dateTo:document.getElementById("dateTo").value,sortBy:document.getElementById("sortBy").value};sessionStorage.setItem("searchState",JSON.stringify(e)),sessionStorage.setItem("lastView","search")}function Ar(){let e={project:document.getElementById("project").value,tool:document.getElementById("tool").value,date:document.getElementById("date").value,dateFrom:document.getElementById("dateFrom").value,dateTo:document.getElementById("dateTo").value,sortBy:document.getElementById("sortBy").value};sessionStorage.setItem("allConversationsState",JSON.stringify(e)),sessionStorage.setItem("lastView","all")}async function ie(){if(sessionStorage.getItem("lastView")==="all"){let o=sessionStorage.getItem("allConversationsState");if(!o)return!1;let i=JSON.parse(o);document.getElementById("project").value=i.project||"",document.getElementById("tool").value=i.tool||"",document.getElementById("date").value=i.date||"",document.getElementById("dateFrom").value=i.dateFrom||"",document.getElementById("dateTo").value=i.dateTo||"",document.getElementById("sortBy").value=i.sortBy||"relevance";let{toggleCustomDate:a,showAllConversations:l}=await Promise.resolve().then(()=>(Se(),sn));return a(),await l(),!0}let t=sessionStorage.getItem("searchState");if(!t)return!1;let n=JSON.parse(t);document.getElementById("search").value=n.query||"",document.getElementById("mode").value=n.mode||"hybrid",document.getElementById("project").value=n.project||"",document.getElementById("tool").value=n.tool||"",document.getElementById("date").value=n.date||"",document.getElementById("dateFrom").value=n.dateFrom||"",document.getElementById("dateTo").value=n.dateTo||"",document.getElementById("sortBy").value=n.sortBy||"relevance";let{toggleCustomDate:r}=await Promise.resolve().then(()=>(Se(),sn));if(r(),!!(n.query||n.project||n.tool||n.date||n.dateFrom||n.dateTo)){let{search:o}=await Promise.resolve().then(()=>(Se(),sn));return o(),!0}return!1}var Ze=M(()=>{});function ai(){document.addEventListener("keydown",xd),Ed()}function xd(e){let t=document.activeElement,n=t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable;if(e.key==="?"&&e.shiftKey){e.preventDefault(),bt();return}if(e.key==="Escape"){if(yt){e.preventDefault(),bt();return}if(n&&t.id==="search"){e.preventDefault(),t.value="";return}return}if(!(n&&t.id!=="search")){if(e.key==="/"){e.preventDefault();let r=document.getElementById("search");r&&(r.focus(),r.select());return}if(e.key==="r"&&!n){e.preventDefault(),window.resumeSession&&window.resumeSession();return}if(e.key==="c"&&!n){e.preventDefault();let r=document.getElementById("chatQuestion");r&&(r.focus(),r.select());return}}}function Ed(){let e=document.createElement("div");e.id="shortcutsHelpModal",e.style.cssText=`
        display: none;
        position: fixed;
        z-index: 10000;
        left: 0;
    ...
    `,document.head.appendChild(t),e.addEventListener("click",n=>{n.target===e&&bt()}),document.body.appendChild(e)}function bt(){let e=document.getElementById("shortcutsHelpModal");e&&(yt=!yt,e.style.display=yt?"block":"none",document.body.style.overflow=yt?"hidden":"")}var yt,li=M(()=>{yt=!1});function ui(){let e=document.getElementById("search");if(!e)return;let t=document.createElement("div");t.id="suggestionsContainer",t.style.cssText=`
        position: absolute;
        display: none;
        background: hsl(var(--bg-elevated));
        border: 1px solid hsl(var(--border-glass));
        ...
        z-index: 1000;
        min-width: 400px;
    `,e.parentNode.style.position="relative",e.parentNode.appendChild(t),e.addEventListener("input",n=>{let r=n.target.value.trim();if(r.length<2){Pe();return}clearTimeout(ci),ci=setTimeout(()=>{wd(r)},300)}),e.addEventListener("keydown",n=>{let r=document.getElementById("suggestionsContainer");if(!r||r.style.display==="none")return;let s=r.querySelectorAll(".suggestion-item");s.length!==0&&(n.key==="ArrowDown"?(n.preventDefault(),ge=Math.min(ge+1,s.length-1),di(s)):n.key==="ArrowUp"?(n.preventDefault(),ge=Math.max(ge-1,-1),di(s)):n.key==="Enter"&&ge>=0?(n.preventDefault(),s[ge].click()):n.key==="Escape"&&Pe())}),document.addEventListener("click",n=>{let r=document.getElementById("search"),s=document.getElementById("suggestionsContainer");r&&s&&!r.contains(n.target)&&!s.contains(n.target)&&Pe()})}async function wd(e){if(document.getElementById("suggestionsContainer"))try{let n=await fetch(`/api/search/suggestions?q=${encodeURIComponent(e)}&limit=10`);if(!n.ok){Pe();return}let r=await n.json();if(!r.suggestions||r.suggestions.length===0){Pe();return}Sd(r.suggestions,e)}catch(n){console.error("Failed to fetch suggestions:",n),Pe()}}function Sd(e,t){let n=document.getElementById("suggestionsContainer");if(!n)return;ge=-1;let r=`
        <div style="
            padding: 8px 12px;
            border-bottom: 1px solid hsl(var(--border-subtle));
            color: hsl(var(--text-tertiary));
    ...
    `;e.forEach((s,o)=>{let i=_d(s,t);r+=`
            <div class="suggestion-item" data-suggestion="${xt(s)}" style="
                padding: 10px 12px;
                cursor: pointer;
                transition: background 0.2s;
                border-bottom: 1px solid hsl(var(--border-subtle));
        ...
        `}),r=r.replace(/border-bottom: 1px solid hsl\(var\(--border-subtle\)\);(?![\s\S]*border-bottom)/,""),n.innerHTML=r,n.style.display="block",n.querySelectorAll(".suggestion-item").forEach(s=>{s.addEventListener("click",()=>{let o=document.getElementById("search");o&&(o.value=s.dataset.suggestion,Pe(),window.search&&window.search())})})}function _d(e,t){let n=e.toLowerCase().indexOf(t.toLowerCase());if(n===-1)return xt(e);let r=xt(e.substring(0,n)),s=xt(e.substring(n,n+t.length)),o=xt(e.substring(n+t.length));return`${r}<strong style="color: hsl(var(--accent)); font-weight: 600;">${s}</strong>${o}`}function di(e){e.forEach((t,n)=>{if(n===ge){t.style.background="hsl(var(--bg-surface))",t.scrollIntoView({block:"nearest"});let r=document.getElementById("search");r&&(r.value=t.dataset.suggestion)}else t.style.background="transparent"})}function Pe(){let e=document.getElementById("suggestionsContainer");e&&(e.style.display="none"),ge=-1}function xt(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}var ci,ge,fi=M(()=>{ci=null,ge=-1});async function pi(){let e=document.getElementById("results"),t=document.getElementById("filters"),n=[document.getElementById("heroTitle"),document.getElementById("heroSubtitle"),document.getElementById("search")];t.style.display="none",n.forEach(r=>{r&&(r.style.display="none")}),e.innerHTML='<div class="loading">Loading analytics...</div>',await hi(e,30)}async function hi(e,t){try{let[n,r,s,o,i,a,l,c]=await Promise.all([fetch("/api/stats/analytics/config"),fetch(`/api/stats/analytics/summary?days=${t}`),fetch(`/api/stats/analytics/top-queries?limit=10&days=${t}`),fetch(`/api/stats/analytics/dead-ends?limit=10&days=${t}`),fetch(`/api/stats/analytics/trends?days=${t}`),fetch(`/api/stats/analytics/heatmap?days=${t}`),fetch(`/api/stats/analytics/agent-comparison?days=${t}`),fetch(`/api/stats/analytics/topics?days=${t}&k=8`)]),u=await n.json(),d=await r.json(),f=await s.json(),h=await o.json(),p=await i.json(),g=await a.json(),m=await l.json(),v=await c.json();e.innerHTML=`
            <div style="max-width: 1200px; margin: 0 auto;">
                ...
                <div class="stat-grid" style="margin-bottom: 40px;">
                    ${on("Total Searches",d.total_searches)}
                    ${on("Unique Queries",d.unique_queries)}
                    ${on("Avg Results",d.avg_results)}
                    ${on("Avg Time (ms)",d.avg_time_ms)}
                </div>
        ...
        <div style="display: grid; gap: 12px;">
            ${e.map((t,n)=>`
                <div class="glass" style="display: flex; align-items: center; gap: 16px; padding: 12px;">
                    ...
                    <div style="flex: 1;">
                        <div style="font-family: var(--font-mono); font-size: 14px; color: hsl(var(--text-primary)); margin-bottom: 4px;">${et(t.query)}</div>
                        <div style="font-size: 12px; color: hsl(var(--text-tertiary));">
    ...
    `}function $d(e){if(!e||e.length===0)return'<div style="color: hsl(var(--text-tertiary)); font-style: italic;">No data available yet.</div>';let t=Math.max(...e.map(a=>a.searches||0),1),n=900,r=120,s=10,o=Math.max(2,Math.floor((n-s*2)/e.length)),i=e.map((a,l)=>{let c=Math.round((a.searches||0)/t*(r-s*2)),u=s+l*o,d=r-s-c;return`<rect x="${u}" y="${d}" width="${o-1}" height="${c}" fill="var(--chart-1)" opacity="0.85"></rect>`}).join("");return`
        <div style="overflow-x: auto;">
            <svg width="${n}" height="${r}" viewBox="0 0 ${n} ${r}" role="img" aria-label="Search trend bars">
                ${i}
            </svg>
        </div>
    `}function Ad(e){if(!e||e.length===0)return'<div style="color: hsl(var(--text-tertiary)); font-style: italic;">No data available yet.</div>';let t=new Map,n=1;for(let a of e){let l=`${a.dow}-${a.hour}`;t.set(l,a.searches),a.searches>n&&(n=a.searches)}let r=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],s=Array.from({length:24},(a,l)=>l),o=`
        ...
        <div style="display: grid; gap: 10px;">
            ${e.map(t=>`
                <div class="glass" style="display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 12px;">
                    <div>
                        <div style="font-weight: 700; color: hsl(var(--text-primary)); text-transform: uppercase;">${et(t.tool_filter)}</div>
            ...
            ${e.map(t=>`
                <div class="glass" style="padding: 14px;">
                    <div style="display: flex; justify-content: space-between; gap: 12px; align-items: baseline;">
                        <div style="font-weight: 800; color: hsl(var(--text-primary));">${et((t.top_terms||[]).join(", ")||"topic")}</div>
                    ...
                    <div style="margin-top: 6px; font-family: var(--font-mono); font-size: 12px; color: hsl(var(--text-tertiary));">
                        ${et(t.representative_query||"")}
                    </div>
                    ${t.examples&&t.examples.length?`
                        <div style="margin-top: 8px; color: hsl(var(--text-tertiary)); font-size: 12px;">
                            Examples: ${et(t.examples.join(" \xB7 "))}
                        </div>
                    `:""}
                </div>
            `).join("")}
        </div>
    `}function Hd(e){return e>=1e3?(e/1e3).toFixed(1)+"k":e.toString()}function et(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}var mi=M(()=>{});function an(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function Md(){try{let e=localStorage.getItem(bi);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to load saved queries from local storage",e),[]}}function Rd(e){localStorage.setItem(bi,JSON.stringify(e))}function tt(e){let t=document.getElementById("savedQueriesStatus");t&&(t.textContent=e||"")}function gi(){return{query:document.getElementById("search").value,mode:document.getElementById("mode").value,filters:{project:document.getElementById("project").value,tool:document.getElementById("tool").value,date:document.getElementById("date").value,date_from:document.getElementById("dateFrom").value,date_to:document.getElementById("dateTo").value,sort_by:document.getElementById("sortBy").value}}}function Dd(e){document.getElementById("search").value=e.query||"",document.getElementById("mode").value=e.mode||"hybrid",document.getElementById("project").value=e.filters?.project||"",document.getElementById("tool").value=e.filters?.tool||"",document.getElementById("date").value=e.filters?.date||"",document.getElementById("sortBy").value=e.filters?.sort_by||"relevance",document.getElementById("dateFrom").value=e.filters?.date_from||"",document.getElementById("dateTo").value=e.filters?.date_to||"",typeof window.toggleCustomDate=="function"&&window.toggleCustomDate()}function Od(){let e=document.getElementById("savedQueriesList");if(!e)return;if(!ce.length){e.innerHTML='<div class="saved-queries-status">No saved queries yet.</div>';return}let t=[];for(let n of ce){let r=n.description?` - ${an(n.description)}`:"",s=n.mode?an(n.mode):"",o=n.filters?.project?` \u2022 ${an(n.filters.project)}`:"",i=`${s}${o}`,a=n.synced===!1?" (local only)":"";t.push(`
            <div class="saved-query-item" data-query-id="${n.id}">
                <div class="saved-query-title">${an(n.name)}${a}</div>
        ...
        `)}e.innerHTML=t.join("")}function vi(e){ln=e;let t=document.getElementById("savedQueriesForm");t&&(t.style.display="grid"),document.getElementById("savedQueryName").value=e?.name||"",document.getElementById("savedQueryDescription").value=e?.description||""}function yi(){ln=null;let e=document.getElementById("savedQueriesForm");e&&(e.style.display="none"),document.getElementById("savedQueryName").value="",document.getElementById("savedQueryDescription").value=""}async function Pd(){try{let e=await fetch("/api/queries");if(!e.ok){let r=await e.json().catch(function(){return null});throw new Error(r?.detail||"Failed to load saved queries")}let t=await e.json();if(!Array.isArray(t.queries))return[];let n=[];for(let r of t.queries)n.push({...r,synced:!0});return n}catch{return tt("Saved queries are available locally only."),null}}async function jd(e){let t=await fetch("/api/queries",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){let r=await t.json().catch(function(){return null});throw new Error(r?.detail||"Failed to save query")}return(await t.json()).query}async function qd(e,t){let n=await fetch(`/api/queries/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!n.ok){let s=await n.json().catch(function(){return null});throw new Error(s?.detail||"Failed to update query")}return(await n.json()).query}async function Nd(e){let t=await fetch(`/api/queries/${e}`,{method:"DELETE"});if(!t.ok){let n=await t.json().catch(function(){return null});throw new Error(n?.detail||"Failed to delete query")}}async function Fd(e){await fetch(`/api/queries/${e}/run`,{method:"POST"})}function je(e){ce=e,Rd(ce),Od()}function Vd(e){for(let t of ce)if(t.id===e)return t;return null}async function xi(){let e=["savedQueryCancel","savedQuerySave","savedQueriesList","savedQueryName","savedQueryDescription"];for(let u of e)if(!document.getElementById(u)){console.error(`Saved queries UI missing element: #${u}`);return}let t=Md(),n=await Pd();n?(je(n),tt("")):je(t);let r=[],s=document.getElementById("saveQueryButton"),o=document.getElementById("saveQueryButtonInline");s&&r.push(s),o&&r.push(o);function i(){vi(gi())}for(let u of r)u.addEventListener("click",i);function a(){yi()}document.getElementById("savedQueryCancel").addEventListener("click",a);async function l(){let u=document.getElementById("savedQueryName").value.trim();if(!u){tt("Name is required to save a query.");return}let d=document.getElementById("savedQueryDescription").value.trim(),f=ln||gi(),h={name:u,description:d||null,query:f.query,filters:f.filters,mode:f.mode};try{if(f.id){let p=await qd(f.id,h),g=[];for(let m of ce)m.id===f.id?g.push({...p,synced:!0}):g.push(m);je(g)}else{let p=`local-${Date.now()}`,g={...h,id:p,created_at:new Date().toISOString(),last_used:null,use_count:0,synced:!1};je([g,...ce]);let m=await jd(h),v=[];for(let y of ce)y.id===p?v.push({...m,synced:!0}):v.push(y);je(v)}tt(""),yi()}catch(p){tt(p.message)}}document.getElementById("savedQuerySave").addEventListener("click",l);async function c(u){let d=u.target;if(!d.dataset.queryId)return;let f=d.dataset.queryId,h=Vd(f);if(h){if(d.classList.contains("saved-query-run")){Dd(h),window.search();let p=[];for(let g of ce)g.id===f?p.push({...g,last_used:new Date().toISOString(),use_count:(g.use_count||0)+1}):p.push(g);je(p),f.startsWith("local-")||Fd(f).catch(function(){return null})}if(d.classList.contains("saved-query-edit")&&(vi(h),ln.id=h.id),d.classList.contains("saved-query-delete")){let p=[];for(let g of ce)g.id!==f&&p.push(g);if(je(p),!f.startsWith("local-"))try{await Nd(f)}catch(g){tt(g.message)}}}}document.getElementById("savedQueriesList").addEventListener("click",c)}var bi,ce,ln,Ei=M(()=>{bi="savedQueries",ce=[],ln=null});function pn(){wt&&(clearInterval(wt),wt=null),fn=null,Mr=null}function P(e){let t=document.createElement("div");return t.textContent=e||"",t.innerHTML}function zd(){let e=document.getElementById("filters"),t=[document.getElementById("heroTitle"),document.getElementById("heroSubtitle"),document.getElementById("search")],n=document.getElementById("chatPanel");e&&(e.style.display="none"),t.forEach(r=>{r&&(r.style.display="none")}),n&&(n.style.display="none"),sessionStorage.setItem("lastView","dashboard")}async function Ud(){let e=await fetch("/api/status/features");return e.ok?e.json():null}async function cn(){let e=await fetch("/api/dashboards");if(!e.ok){let t=await e.json().catch(()=>null);throw new Error(t?.detail||"Failed to load dashboards")}return e.json()}async function Wd(e){let t=await fetch(`/api/dashboards/${e}`);if(!t.ok){let n=await t.json().catch(()=>null);throw new Error(n?.detail||"Failed to load dashboard")}return t.json()}async function dn(){let e=await fetch("/api/queries");if(!e.ok){let t=await e.json().catch(()=>null);throw new Error(t?.detail||"Failed to load saved queries")}return e.json()}async function Jd(e){let t=await fetch("/api/dashboards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){let n=await t.json().catch(()=>null);throw new Error(n?.detail||"Failed to create dashboard")}return t.json()}async function Kd(e,t){let n=await fetch(`/api/dashboards/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!n.ok){let r=await n.json().catch(()=>null);throw new Error(r?.detail||"Failed to update dashboard")}return n.json()}async function Xd(e){let t=await fetch(`/api/dashboards/${e}`,{method:"DELETE"});if(!t.ok){let n=await t.json().catch(()=>null);throw new Error(n?.detail||"Failed to delete dashboard")}}async function Et(e,t){t.innerHTML='<div class="dashboard-loading">Loading dashboard...</div>';let n=await fetch(`/api/dashboards/${e}/render`);if(!n.ok){let l=await n.json().catch(()=>null);throw new Error(l?.detail||"Failed to render dashboard")}let r=await n.json(),s=r.dashboard||{},o=Array.isArray(r.widgets)?r.widgets:[],i=Number.isFinite(s.refresh_interval)?s.refresh_interval:null,a=o.map(l=>{let c=Array.isArray(l.results)?l.results:[],u=c.length?c.map(d=>`
    ...
    `}function Si(e){let t=e?.query_id||"",n=e?.title||"",r=Number.isFinite(e?.limit)?e.limit:"",s=e?.sort_by||"",o=e?.id||"",i=Rr.map(a=>{let l=a.id===t?"selected":"";return`<option value="${a.id}" ${l}>${P(a.name)} \u2014 ${P(a.query)}</option>`}).join("");return`
    ...
    `}function eu(){let e=document.querySelectorAll('.dashboard-queries input[type="checkbox"]'),t=[];return e.forEach(n=>{n.checked&&t.push(n.value)}),t}async function _i(){let e=document.getElementById("results");if(e){zd(),e.innerHTML='<div class="dashboard-loading">Loading dashboards...</div>';try{if(!(await Ud())?.dashboards?.enabled)e.innerHTML=`
                <div class="dashboard-panel">
                    <h2>Dashboards</h2>
            ...
            `;else{let[n,r]=await Promise.all([cn(),dn()]);Rr=Array.isArray(r.queries)?r.queries:[],un(e,n.dashboards,r.queries)}wi||(e.addEventListener("click",async n=>{let r=n.target;if(!(r instanceof HTMLElement))return;let s=r.dataset.action,o=r.dataset.dashboardId;if(s==="back"){pn(),Y(),await ie()||(sessionStorage.removeItem("lastView"),Y());return}if(s==="create"){let i=document.getElementById("dashboardStatus"),a=document.getElementById("dashboardName").value.trim();if(!a){i&&(i.textContent="Dashboard name is required.");return}let l=document.getElementById("dashboardDescription").value.trim(),c=document.getElementById("dashboardRefresh").value.trim(),u=c?Number.parseInt(c,10):null,d=eu();if(!d.length){i&&(i.textContent="Select at least one saved query.");return}let f=d.map(p=>({query_id:p})),h={name:a,description:l||null,refresh_interval:Number.isFinite(u)?u:null,queries:d,layout:{widgets:f}};try{await Jd(h);let[p,g]=await Promise.all([cn(),dn()]);un(e,p.dashboards,g.queries)}catch(p){i&&(i.textContent=p.message)}}if(s==="view"&&o){let i=document.getElementById("dashboardView");if(!i)return;try{await Et(o,i)}catch(a){i.innerHTML=`<div class="dashboard-empty">${P(a.message)}</div>`}}if(s==="edit"&&o){let i=document.getElementById("dashboardView");if(!i)return;try{let l=(await Wd(o)).dashboard;if(!l)throw new Error("Dashboard not found");Qd(l,i)}catch(a){i.innerHTML=`<div class="dashboard-empty">${P(a.message)}</div>`}}if(s==="refresh"&&o){let i=document.getElementById("dashboardView");if(!i)return;try{await Et(o,i)}catch(a){i.innerHTML=`<div class="dashboard-empty">${P(a.message)}</div>`}}if(s==="delete"&&o){if(!window.confirm("Delete this dashboard?"))return;try{await Xd(o);let[a,l]=await Promise.all([cn(),dn()]);un(e,a.dashboards,l.queries)}catch(a){let l=document.getElementById("dashboardStatus");l&&(l.textContent=a.message)}}if(s==="builder-add-widget"&&o){let i=document.getElementById("dashboardView");if(!i)return;Yd(i)}if(s==="builder-remove-widget"){let i=r.closest(".dashboard-builder-widget");i&&i.remove()}if(s==="builder-move-up"||s==="builder-move-down"){let i=r.closest(".dashboard-builder-widget");if(!i)return;s==="builder-move-up"&&i.previousElementSibling&&i.parentNode.insertBefore(i,i.previousElementSibling),s==="builder-move-down"&&i.nextElementSibling&&i.parentNode.insertBefore(i.nextElementSibling,i)}if(s==="builder-cancel"&&o){let i=document.getElementById("dashboardView");if(!i)return;try{await Et(o,i)}catch(a){i.innerHTML=`<div class="dashboard-empty">${P(a.message)}</div>`}}if(s==="builder-save"&&o){let i=document.getElementById("dashboardView");if(!i)return;let a=i.querySelector("#dashboardBuilderStatus");a&&(a.textContent="");try{let l=Gd(i);await Kd(o,l);let[c,u]=await Promise.all([cn(),dn()]);Rr=Array.isArray(u.queries)?u.queries:[],un(e,c.dashboards,u.queries);let d=document.getElementById("dashboardView");d&&await Et(o,d)}catch(l){a&&(a.textContent=l.message)}}if(r.classList.contains("dashboard-result-open")){n.preventDefault();let i=r.dataset.conversationId;i&&await we(i)}}),wi=!0)}catch(t){e.innerHTML=`<div class="dashboard-empty">Failed to load dashboards: ${P(t.message)}</div>`}}}var wi,wt,fn,Mr,Rr,Ci=M(()=>{Se();Ze();wi=!1,wt=null,fn=null,Mr=null,Rr=[]});function A(e){let t=document.createElement("div");return t.textContent=e||"",t.innerHTML}function tu(){let e=document.getElementById("filters"),t=document.querySelector(".toolbar"),n=[document.getElementById("heroTitle"),document.getElementById("heroSubtitle")];e&&(e.style.display="none"),t&&(t.style.display="none"),n.forEach(r=>{r&&(r.style.display="none")}),sessionStorage.setItem("lastView","expertise")}function nu(){let e=document.getElementById("filters"),t=document.querySelector(".toolbar");e&&(e.style.display=""),t&&(t.style.display="")}async function St(e){let t=await fetch(e);if(!t.ok){let n=await t.json().catch(()=>null);throw new Error(n?.detail||`Request failed: ${t.status}`)}return t.json()}async function ru(){return St("/api/expertise/status")}async function su(){return St("/api/expertise/domains")}async function ou(e,t=0,n=nt){let r=new URLSearchParams;return e.domain&&r.set("domain",e.domain),e.type&&r.set("type",e.type),e.project&&r.set("project",e.project),e.tags&&r.set("tags",e.tags),e.severity&&r.set("severity",e.severity),e.q&&r.set("q",e.q),r.set("active_only",String(e.active_only)),r.set("limit",String(n)),r.set("offset",String(t)),St(`/api/expertise?${r.toString()}`)}async function iu(e){return St(`/api/expertise/${encodeURIComponent(e)}`)}async function au(e){return St(`/api/knowledge-graph/lineage/${encodeURIComponent(e)}`)}function lu(e){return`<span class="health-badge health-badge--${e==="healthy"?"healthy":e==="critical"?"critical":"warning"}">${A(e)}</span>`}function cu(e){let t=Array.isArray(e.domains)?e.domains:[];return t.length?`
    ...
    `}function uu(e){let t=e.map(n=>`<option value="${A(n.name)}">${A(n.name)}</option>`).join("");return`
        <div class="expertise-filter-bar" id="expertiseFilterBar">
            <input type="text" id="expertiseSearch" placeholder="Search records..." value="${A(R.filters.q)}" />
    ...
    `}function fu(e,t){return e.length?`
        <div class="expertise-record-list">${e.map(r=>{let s=(r.tags||[]).map(i=>`<span class="expertise-tag">${A(i)}</span>`).join(""),o=r.confidence!=null?`${Math.round(r.confidence*100)}%`:"";return`
            <div class="expertise-record-item" data-record-id="${A(r.id)}">
                <div class="expertise-record-main">
                    <div class="expertise-record-title">${A(r.name||r.content.slice(0,80))}</div>
                    <div class="expertise-record-meta">
                        <span>${A(r.type)}</span>
                        <span>${A(r.domain)}</span>
                        ${r.project?`<span>${A(r.project)}</span>`:""}
                        ${r.severity?`<span>${A(r.severity)}</span>`:""}
                    </div>
        ...
        `}).join("")}</div>
    `:'<div class="expertise-empty">No records match the current filters.</div>'}function pu(e,t){let n=Math.max(1,Math.ceil(e/nt));if(n<=1)return"";let r=t*nt+1,s=Math.min((t+1)*nt,e);return`
    ...
    `}function hu(e,t){let n=(e.tags||[]).map(o=>`<span class="expertise-tag">${A(o)}</span>`).join(""),r=(t?.conversations||[]).map(o=>`<li><a href="/conversation/${encodeURIComponent(o)}">${A(o)}</a></li>`).join(""),s=(t?.derived_records||[]).map(o=>`<li>${A(o)}</li>`).join("");return`
        <div class="expertise-detail-panel" id="expertiseDetailPanel">
            <div class="expertise-detail-header">
                <h3>${A(e.name||e.type)}</h3>
            ...
            <div class="expertise-detail-meta-grid">
                <div class="expertise-detail-field">
                    ...
                    <span class="expertise-detail-field-value">${A(e.type)}</span>
                </div>
                <div class="expertise-detail-field">
                    <span class="expertise-detail-field-label">Domain</span>
                    <span class="expertise-detail-field-value">${A(e.domain)}</span>
                </div>
                ${e.project?`
                <div class="expertise-detail-field">
                    <span class="expertise-detail-field-label">Project</span>
                    <span class="expertise-detail-field-value">${A(e.project)}</span>
                </div>`:""}
                ${e.severity?`
                <div class="expertise-detail-field">
                    <span class="expertise-detail-field-label">Severity</span>
                    <span class="expertise-detail-field-value">${A(e.severity)}</span>
                </div>`:""}
                <div class="expertise-detail-field">
            ...
            <div class="expertise-detail-content">${A(e.content)}</div>
            ${e.example?`<div class="expertise-detail-field"><span class="expertise-detail-field-label">Example</span><div class="expertise-detail-content" style="margin-top:4px;">${A(e.example)}</div></div>`:""}
            ${e.rationale?`<div class="expertise-detail-field"><span class="expertise-detail-field-label">Rationale</span><div class="expertise-detail-content" style="margin-top:4px;">${A(e.rationale)}</div></div>`:""}
            ${n?`<div class="expertise-record-tags">${n}</div>`:""}
            ${e.source_conversation_id?`
                <div class="expertise-detail-provenance">
                    <span>Source:</span>
                    <a href="/conversation/${encodeURIComponent(e.source_conversation_id)}">${A(e.source_conversation_id)}</a>
                    ${e.source_agent?`<span>via ${A(e.source_agent)}</span>`:""}
                </div>`:""}
            ${r||s?`
    ...
    `}function Dr(e){e.querySelector(".expertise-inline-detail")?.remove()}function mu(e,t){Dr(e);let n=document.createElement("div");return n.className="expertise-inline-detail",t.insertAdjacentElement("afterend",n),n}async function gu(e){e.innerHTML='<div class="expertise-loading">Loading domain status...</div>';try{let t=await ru();e.innerHTML=du(t)+cu(t),e.querySelectorAll(".expertise-table tbody tr").forEach(n=>{n.addEventListener("click",()=>{R.filters.domain=n.dataset.domain||"",R.page=0,Or(document.getElementById("results"),"records")})})}catch(t){e.innerHTML=`<div class="expertise-error">${A(t.message)}</div>`}}async function hn(e){e.innerHTML='<div class="expertise-loading">Loading records...</div>';try{let[t,n]=await Promise.all([su(),ou(R.filters,R.page*nt)]),r=uu(t),s=fu(n.results,n.total),o=pu(n.total,R.page);e.innerHTML=r+s+o;let i=e.querySelector("#expertiseDomainFilter");i&&(i.value=R.filters.domain);let a=e.querySelector("#expertiseTypeFilter");a&&(a.value=R.filters.type);let l=e.querySelector("#expertiseSeverityFilter");l&&(l.value=R.filters.severity);let c=e.querySelector("#expertiseApplyFilters");c&&c.addEventListener("click",()=>{R.filters.q=e.querySelector("#expertiseSearch")?.value?.trim()||"",R.filters.type=e.querySelector("#expertiseTypeFilter")?.value||"",R.filters.domain=e.querySelector("#expertiseDomainFilter")?.value||"",R.filters.severity=e.querySelector("#expertiseSeverityFilter")?.value||"",R.filters.active_only=e.querySelector("#expertiseActiveOnly")?.checked??!0,R.page=0,hn(e)});let u=e.querySelector("#expertiseSearch");u&&u.addEventListener("keypress",d=>{d.key==="Enter"&&c?.click()}),e.querySelectorAll(".expertise-record-item").forEach(d=>{d.addEventListener("click",async()=>{let f=d.dataset.recordId;if(!f)return;if(R.selectedRecordId===f){R.selectedRecordId=null,d.classList.remove("selected"),Dr(e);return}R.selectedRecordId=f,e.querySelectorAll(".expertise-record-item").forEach(p=>p.classList.remove("selected")),d.classList.add("selected");let h=mu(e,d);h.innerHTML='<div class="expertise-loading">Loading record...</div>';try{let[p,g]=await Promise.all([iu(f),au(f).catch(()=>null)]);h.innerHTML=hu(p,g),h.querySelector("#expertiseDetailClose")?.addEventListener("click",()=>{Dr(e),h.innerHTML="",R.selectedRecordId=null,d.classList.remove("selected")}),d.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(p){h.innerHTML=`<div class="expertise-error">${A(p.message)}</div>`}})}),e.querySelector("#expertisePrevPage")?.addEventListener("click",()=>{R.page>0&&(R.page--,hn(e))}),e.querySelector("#expertiseNextPage")?.addEventListener("click",()=>{let d=Math.ceil(n.total/nt);R.page<d-1&&(R.page++,hn(e))})}catch(t){e.innerHTML=`<div class="expertise-error">${A(t.message)}</div>`}}function Or(e,t){R.activeTab=t,e.querySelectorAll(".expertise-tab-btn").forEach(r=>{r.classList.toggle("active",r.dataset.tab===t)}),e.querySelectorAll(".expertise-tab-panel").forEach(r=>{r.classList.toggle("active",r.dataset.panel===t)});let n=e.querySelector(`.expertise-tab-panel[data-panel="${t}"]`);n&&(t==="domains"?gu(n):t==="records"&&hn(n))}async function Pr(){let e=document.getElementById("results");if(!e)return;tu(),e.innerHTML=`
    ...
    `,e.querySelectorAll(".expertise-tab-btn").forEach(n=>{n.addEventListener("click",()=>Or(e,n.dataset.tab))}),e.querySelector("#expertiseBackBtn")?.addEventListener("click",async()=>{nu(),Y(),await ie()||(sessionStorage.removeItem("lastView"),Y())});let t=R.activeTab||"domains";Or(e,t)}var nt,R,ki=M(()=>{Se();Ze();nt=25,R={page:0,filters:{type:"",domain:"",project:"",tags:"",severity:"",active_only:!0,q:""},selectedRecordId:null,activeTab:"domains"}});function K(e){let t=document.createElement("div");return t.textContent=e||"",t.innerHTML}function vu(){let e=document.getElementById("filters"),t=document.querySelector(".toolbar"),n=[document.getElementById("heroTitle"),document.getElementById("heroSubtitle")];e&&(e.style.display="none"),t&&(t.style.display="none"),n.forEach(r=>{r&&(r.style.display="none")}),sessionStorage.setItem("lastView","contradictions")}function yu(){let e=document.getElementById("filters"),t=document.querySelector(".toolbar");e&&(e.style.display=""),t&&(t.style.display="")}async function jr(e){let t=await fetch(e);if(!t.ok){let n=await t.json().catch(()=>null);throw new Error(n?.detail||`Request failed: ${t.status}`)}return t.json()}async function bu(e,t){let n=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!n.ok){let r=await n.json().catch(()=>null);throw new Error(r?.detail||`Request failed: ${n.status}`)}return n.json()}async function xu(e=!0){let t=new URLSearchParams({unresolved_only:String(e)});return jr(`/api/knowledge-graph/contradictions?${t.toString()}`)}async function Ii(e){return jr(`/api/expertise/${encodeURIComponent(e)}`)}async function Eu(){return jr("/api/knowledge-graph/stats")}async function Ct(e,t,n){return bu("/api/knowledge-graph/resolve",{edge_id:e,strategy:t,params:n})}function wu(e){let t=Math.round((e.health_score??0)*100),n=t>=80?"var(--success)":t>=50?"var(--warning)":"var(--danger)";return`
    ...
    `}function Ai(e){e.querySelector(".contradiction-inline-detail")?.remove()}function Cu(e,t){Ai(e);let n=document.createElement("div");return n.className="contradiction-inline-detail",t.insertAdjacentElement("afterend",n),n}function ku(e,t,n,r,s){let o=e.querySelector("#contradictionStatus"),i=e.querySelector("#contradictionScopeInput"),a=e.querySelector("#contradictionMergeInput"),l=e.querySelector("#contradictionDismissInput"),c=e.querySelector("#contradictionKeepBothInput");function u(){[i,a,l,c].forEach(d=>{d&&d.classList.remove("visible")})}e.querySelectorAll("[data-strategy]").forEach(d=>{d.addEventListener("click",async()=>{let f=d.dataset.strategy;if(u(),o.textContent="",o.className="contradiction-status",f==="supersede"){let h=d.dataset.winner;try{await Ct(t,"supersede",{winner_id:h}),o.textContent="Resolved: supersede applied.",o.classList.add("success"),s()}catch(p){o.textContent=p.message,o.classList.add("error")}}else f==="scope_both"?i.classList.add("visible"):f==="merge"?a.classList.add("visible"):f==="dismiss"?l.classList.add("visible"):f==="keep_both"&&c.classList.add("visible")})}),e.querySelector("#confirmScope")?.addEventListener("click",async()=>{let d=e.querySelector("#scopeA")?.value?.trim(),f=e.querySelector("#scopeB")?.value?.trim();if(!d||!f){o.textContent="Both scope fields required.",o.classList.add("error");return}try{await Ct(t,"scope_both",{scope_a:d,scope_b:f}),o.textContent="Resolved: scopes applied.",o.classList.add("success"),s()}catch(h){o.textContent=h.message,o.classList.add("error")}}),e.querySelector("#confirmMerge")?.addEventListener("click",async()=>{let d=e.querySelector("#mergedContent")?.value?.trim();if(!d){o.textContent="Merged content required.",o.classList.add("error");return}try{await Ct(t,"merge",{merged_content:d}),o.textContent="Resolved: records merged.",o.classList.add("success"),s()}catch(f){o.textContent=f.message,o.classList.add("error")}}),e.querySelector("#confirmDismiss")?.addEventListener("click",async()=>{let d=e.querySelector("#dismissReason")?.value?.trim();if(!d){o.textContent="Dismiss reason required.",o.classList.add("error");return}try{await Ct(t,"dismiss",{reason:d}),o.textContent="Resolved: contradiction dismissed.",o.classList.add("success"),s()}catch(f){o.textContent=f.message,o.classList.add("error")}}),e.querySelector("#confirmKeepBoth")?.addEventListener("click",async()=>{let d=e.querySelector("#keepBothReason")?.value?.trim();if(!d){o.textContent="Reason required.",o.classList.add("error");return}try{await Ct(t,"keep_both",{reason:d}),o.textContent="Resolved: both records kept.",o.classList.add("success"),s()}catch(f){o.textContent=f.message,o.classList.add("error")}})}async function qr(e,t=!0){e.innerHTML='<div class="expertise-loading">Loading contradictions...</div>';try{let[n,r]=await Promise.all([Eu(),xu(t)]),s=wu(n),o=Su(r.results||[]);e.innerHTML=`
            ...
            ${o}
        `,e.querySelector("#contradictionUnresolvedOnly")?.addEventListener("change",i=>{qr(e,i.target.checked)}),e.querySelectorAll(".contradiction-item").forEach(i=>{i.addEventListener("click",async a=>{a.target.dataset.resolveEdge||a.target.closest("[data-resolve-edge]")||$i(e,i)})}),e.querySelectorAll("[data-resolve-edge]").forEach(i=>{i.addEventListener("click",async()=>{let a=i.closest(".contradiction-item");a&&$i(e,a)})})}catch(n){e.innerHTML=`<div class="expertise-error">${K(n.message)}</div>`}}async function $i(e,t){let n=t.dataset.edgeId,r=t.dataset.recordA,s=t.dataset.recordB;if(!n)return;if(_t.selectedEdgeId===n){_t.selectedEdgeId=null,t.classList.remove("selected"),Ai(e);return}e.querySelectorAll(".contradiction-item").forEach(i=>i.classList.remove("selected")),t.classList.add("selected");let o=Cu(e,t);o.innerHTML='<div class="expertise-loading">Loading records...</div>';try{let[i,a]=await Promise.all([Ii(r),Ii(s)]);_t.recordA=i,_t.recordB=a,_t.selectedEdgeId=n,o.innerHTML=`
        ...
        `;let l=e.querySelector("#contradictionUnresolvedOnly")?.checked??!0;ku(o,n,i,a,()=>{setTimeout(()=>qr(e,l),800)}),t.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(i){o.innerHTML=`<div class="expertise-error">${K(i.message)}</div>`}}async function Nr(){let e=document.getElementById("results");if(!e)return;vu(),e.innerHTML=`
        <div class="expertise-view">
            <div class="expertise-header">
                <div>
...
`,n+="DELETE /api/backup/delete/{name}",alert(n)}catch(e){alert(`Error loading backups: ${e.message}`)}}var Di=M(()=>{});async function Pi(){let e=document.getElementById("results"),t=document.getElementById("filters"),n=[document.getElementById("heroTitle"),document.getElementById("heroSubtitle"),document.getElementById("search")];t.style.display="none",n.forEach(r=>{r&&(r.style.display="none")}),e.innerHTML='<div class="loading">Loading disk usage...</div>',await ji(e)}async function ji(e){try{let t=await fetch("/api/disk");if(!t.ok)throw new Error(`Request failed with status ${t.status}`);let n=await t.json();e.innerHTML=`
            <div style="max-width: 1200px; margin: 0 auto;">
                ...
                <div class="glass" style="margin-bottom: 24px;">
                    ...
                    <p style="color: hsl(var(--text-secondary)); margin: 0 0 16px 0; font-size: 14px;">Index, backups, models, and expertise storage under ${de(n.searchat_self.search_dir)}.</p>
                    ${Bu(n.searchat_self)}
                </div>
        ...
        `;let r=document.getElementById("diskRefresh");r&&r.addEventListener("click",async()=>{e.innerHTML='<div class="loading">Loading disk usage...</div>',await ji(e)})}catch(t){e.innerHTML=`
            <div style="text-align: center; padding: 40px; color: hsl(var(--danger));">
                Failed to load disk usage: ${de(t.message)}
                <br><br>
                <a href="/" style="color: hsl(var(--accent));">&#8592; Back to Search</a>
            </div>
        `}}function Au(e){return!e||e.length===0?'<div style="color: hsl(var(--text-tertiary)); font-style: italic;">No registered connectors discovered any files.</div>':`
        <div class="stat-grid" style="margin-bottom: 20px;">
            ${e.map(t=>Lu(t)).join("")}
        </div>
    `}function Lu(e){let t=e.unindexed_file_count>0?"bad":"good";return`
        <div class="stat-card" style="min-width: 220px;">
            <div class="stat-label">${de(e.connector)}</div>
            <div class="stat-value neutral">${mn(e.total_size_bytes)}</div>
        ...
        <div style="display: grid; gap: 8px; margin-bottom: 12px;">
            ${e.subdirectories.map(t=>`
                <div class="glass" style="display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 10px 14px;">
                    <div style="font-weight: 600; color: hsl(var(--text-primary)); text-transform: capitalize;">${de(t.label)}</div>
                    <div style="font-size: 13px; color: hsl(var(--text-tertiary));">
                        ${t.exists?`${mn(t.total_size_bytes)} &middot; ${t.file_count} files`:'<span style="font-style: italic;">not present</span>'}
                    </div>
                </div>
            `).join("")}
        </div>
        <div style="font-weight: 700; color: hsl(var(--text-primary));">
            Total: ${mn(e.total_size_bytes)} across ${e.total_file_count} files
        </div>
    `}function Hu(e){return!e||e.length===0?'<div style="color: hsl(var(--text-tertiary)); font-style: italic;">No known cruft patterns matched on this machine.</div>':`
        <div style="display: grid; gap: 8px;">
            ${e.map(t=>`
                <div class="glass" style="display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 10px 14px;">
                    <div style="min-width: 0;">
                        <div style="font-weight: 600; color: hsl(var(--text-primary));">${de(t.label)}</div>
                        <div style="font-size: 12px; color: hsl(var(--text-tertiary)); overflow-wrap: anywhere;">${de(t.path)}</div>
                        <div style="font-size: 12px; color: hsl(var(--text-tertiary)); margin-top: 2px;">${de(t.explanation)}</div>
                    </div>
                    <div style="font-size: 14px; font-weight: 700; color: hsl(var(--text-primary)); white-space: nowrap;">
                        ${mn(t.total_size_bytes)}
                    </div>
                </div>
            `).join("")}
        </div>
    `}function Mu(e){return!e||e.length===0?'<div style="color: hsl(var(--text-tertiary)); font-style: italic;">No cross-connector near-duplicate conversations found.</div>':`
        <div style="display: grid; gap: 8px;">
            ${e.map(t=>`
                <div class="glass" style="display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 10px 14px;">
                    <div style="min-width: 0;">
                        <div style="font-weight: 600; color: hsl(var(--text-primary));">${de(t.title_a)}</div>
                        <div style="font-size: 12px; color: hsl(var(--text-tertiary));">
                            ${de(t.connector_a)} &harr; ${de(t.connector_b)}
                        </div>
                    </div>
                    <div style="font-size: 14px; font-weight: 700; color: hsl(var(--text-primary)); white-space: nowrap;">
                        ${(t.similarity*100).toFixed(0)}% similar
                    </div>
                </div>
            `).join("")}
        </div>
    `}function mn(e){let t=Number(e)||0,n=["B","KB","MB","GB","TB"],r=0;for(;Math.abs(t)>=1024&&r<n.length-1;)t/=1024,r+=1;return`${t.toFixed(1)} ${n[r]}`}function Oi(e){return e==null?"-":e<1?`${Math.round(e*24)}h`:`${Math.round(e)}d`}function de(e){let t=document.createElement("div");return t.textContent=e??"",t.innerHTML}var qi=M(()=>{});function Ni(){try{return JSON.parse(localStorage.getItem(Fi)||"{}")}catch{return{}}}function Ru(e){localStorage.setItem(Fi,JSON.stringify(e))}function Vi(){let e=document.querySelectorAll(".sidebar"),t=Ni();e.forEach((n,r)=>{n.querySelectorAll(".sidebar-section").forEach((o,i)=>{let a=`sidebar-${r}-section-${i}`,l=o.querySelector("h3");if(!l)return;let c=document.createElement("div");for(c.className="sidebar-section-content";l.nextSibling;)c.appendChild(l.nextSibling);o.appendChild(c),l.classList.add("sidebar-section-toggle"),l.setAttribute("role","button"),l.setAttribute("tabindex","0");let u=l.textContent.toLowerCase(),d=!u.includes("backup")&&!u.includes("system overview");(t[a]!==void 0?t[a]:d)?l.setAttribute("aria-expanded","true"):(o.classList.add("section-collapsed"),l.setAttribute("aria-expanded","false")),l.addEventListener("click",()=>{let h=o.classList.toggle("section-collapsed");l.setAttribute("aria-expanded",(!h).toString());let p=Ni();p[a]=!h,Ru(p)}),l.addEventListener("keydown",h=>{(h.key==="Enter"||h.key===" ")&&(h.preventDefault(),l.click())})})})}var Fi,zi=M(()=>{Fi="sidebar-sections-state"});function Ui(){Du(),Ou(),Pu(),ju()}function Du(){let e=document.querySelector(".container"),t=document.getElementById("sidebarToggle"),n=document.getElementById("rightPanelToggle");e&&(localStorage.getItem("sidebar-collapsed")==="true"&&e.classList.add("sidebar-collapsed"),localStorage.getItem("right-collapsed")==="true"&&e.classList.add("right-collapsed"),t?.addEventListener("click",()=>{e.classList.toggle("sidebar-collapsed"),localStorage.setItem("sidebar-collapsed",e.classList.contains("sidebar-collapsed"))}),n?.addEventListener("click",()=>{e.classList.toggle("right-collapsed"),localStorage.setItem("right-collapsed",e.classList.contains("right-collapsed"))}))}function Ou(){document.addEventListener("keydown",e=>{(e.metaKey||e.ctrlKey)&&e.key==="k"&&(e.preventDefault(),document.getElementById("search")?.focus())})}function kt(){qe&&(qe.remove(),qe=null)}function Pu(){let e=new Set(["mode","sortBy"]);document.addEventListener("click",t=>{qe&&!t.target.closest(".filter-chip")&&!t.target.closest(".filter-dropdown")&&kt()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&kt()}),document.querySelectorAll(".filter-chip[data-for]").forEach(t=>{let n=t.dataset.for,r=document.getElementById(n);if(!r)return;let s=t.querySelector(".filter-value");t.addEventListener("click",i=>{if(i.stopPropagation(),qe&&qe.dataset.forChip===n){kt();return}kt();let a=document.createElement("div");a.className="filter-dropdown",a.dataset.forChip=n,Array.from(r.options).forEach((c,u)=>{let d=document.createElement("button");d.type="button",d.className="filter-dropdown-item",d.textContent=c.text,u===r.selectedIndex&&d.classList.add("selected"),d.addEventListener("click",()=>{r.selectedIndex=u,r.dispatchEvent(new Event("change")),kt()}),a.appendChild(d)});let l=t.getBoundingClientRect();a.style.position="fixed",a.style.top=`${l.bottom+4}px`,a.style.left=`${l.left}px`,document.body.appendChild(a),qe=a});function o(){let i=r.options[r.selectedIndex]?.text||"";s&&(s.textContent=i);let a=e.has(n)||r.selectedIndex>0;t.classList.toggle("active",a)}r.addEventListener("change",o),o()})}function ju(){document.querySelectorAll(".nav-item[data-action]").forEach(e=>{e.addEventListener("click",()=>{document.querySelectorAll(".nav-item").forEach(t=>t.classList.remove("active")),e.classList.add("active")})})}var qe,Wi=M(()=>{qe=null});function qu(){return`
