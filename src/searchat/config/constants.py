...
DEFAULT_RANKING_KEYWORD_WEIGHT = 0.6
DEFAULT_RANKING_SEMANTIC_WEIGHT = 0.4
DEFAULT_RANKING_BM25_K1 = 1.2
DEFAULT_RANKING_BM25_B = 0.75

# Environment variable names for ranking
ENV_SEARCH_ENGINE = "SEARCHAT_SEARCH_ENGINE"
ENV_RANKING_INTERSECTION_BOOST = "SEARCHAT_RANKING_INTERSECTION_BOOST"
ENV_RANKING_KEYWORD_WEIGHT = "SEARCHAT_RANKING_KEYWORD_WEIGHT"
...
# M9 tiered memory: conversations older than this get an LLM distillate and
# their verbatim exchanges leave the hot FTS/HNSW index (Parquet-equivalent
# conversations/messages tables retained, always re-promotable).
DEFAULT_DISTILLATION_AGE_THRESHOLD_DAYS = 180
...
ENV_DISTILLATION_AGE_THRESHOLD_DAYS = "SEARCHAT_DISTILLATION_AGE_THRESHOLD_DAYS"
